...
def generate_example_explanation() -> tuple[HeteroExplanation, dict[str, list[str]]]:
    ...
    explanation['paper', 'belongs_to', 'topic'].edge_index = data['paper', 'belongs_to', 'topic'].edge_index
    ...
    explanation['author', 'affiliated_with', 'institution'].edge_mask = torch.tensor([
